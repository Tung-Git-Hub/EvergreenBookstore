...
public class CustomerServices {
	...
	public void createCustomer() throws ServletException, IOException {
		...
		if(existCustomer!=null) {
			...
			updateCustomerFeildFromForm(newCustomer);
	...
	public void updateCustomer() throws ServletException, IOException {
		...
		if(customerByEmail!=null && customerByEmail.getCustomerId()!=customerId) {
			...
			updateCustomerFeildFromForm(customerById);
	...
	public void registerCustomer() throws ServletException, IOException {
		...
		if(existCustomer!=null) {
			...
			updateCustomerFeildFromForm(newCustomer);
			customerDAO.create(newCustomer);
			 message = "You have registered successfully. Thank you!" + "<a href = 'login' >Click here</a> to login";
	...
	private void updateCustomerFeildFromForm(Customer customer) {
	...
	public void updateCustomerProfile() throws ServletException, IOException {
		...
		updateCustomerFeildFromForm(customer);
